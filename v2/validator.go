...
func (v *Validation) NoSpaces(field Field) {
	// TODO - remove govalidator dep
	//if govalidator.HasWhitespace(field.Value) {
	//	v.AddError(field.Name, fmt.Sprintf("%s does not allow spaces", field.Label))
	//}
}
